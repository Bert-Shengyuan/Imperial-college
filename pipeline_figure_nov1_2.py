...
plt.tight_layout()
plt.savefig('/Users/sonmjack/Downloads/figure_compare/firing rate map/' + str(index) + '_young_nov_'+str(neuron)+'.png',dpi=800)
plt.show()
# Display the plot
# fig, ax = plt.subplots(figsize=(8, 6))
# # Create the heatmap plot
...
for index in range(len(All_spike)):
    ...
    if Type == 'Young':
        plt.savefig('/Users/sonmjack/Downloads/age2 result_nov/tuning_curve_new/'+f'{type}_{index}'+'.jpg')
    elif Type =='Old':
        plt.savefig('/Users/sonmjack/Downloads/age10 result_nov/tuning_curve_new/' + f'{type}_{index}' + '.jpg')
    plt.close()
...
# if Type == 'Young':
#     with open('/Users/sonmjack/Downloads/age2 result_nov/nov_all_angle_noise.pkl', 'wb') as file:
#         pickle.dump(All_angle_noise, file)
#     with open('/Users/sonmjack/Downloads/age2 result_nov/nov_all_noise_corr.pkl', 'wb') as file:
#         pickle.dump(All_noise_corr, file)
# elif Type =='Old':
#     with open('/Users/sonmjack/Downloads/age10 result_nov/nov_all_angle_noise.pkl', 'wb') as file:
#         pickle.dump(All_angle_noise, file)
#     with open('/Users/sonmjack/Downloads/age10 result_nov/nov_all_noise_corr.pkl', 'wb') as file:
#         pickle.dump(All_noise_corr, file)
#%%
if Type == 'Young':
...
for index in range(len(All_spike)):
    if gene_list[index] == 119:
        ...
        pass
if Type == 'Young':
    with open('/Users/sonmjack/Downloads/age2 result_nov/nov_signal_corr_WT', 'wb') as file:
        pickle.dump(All_signal_corr_WT, file)
    plt.savefig('/Users/sonmjack/Downloads/age2 result_nov/signal_corr/' + 'Whole signal corr' + '.jpg')
    plt.close()
elif Type == 'Old':
    with open('/Users/sonmjack/Downloads/age10 result_nov/nov_signal_corr_WT', 'wb') as file:
        pickle.dump(All_signal_corr_WT, file)
    plt.savefig('/Users/sonmjack/Downloads/age10 result_nov/signal_corr/' + 'Whole signal corr' + '.jpg')
    plt.close()
...
for index in range(len(All_tuning_curve)):
    if gene_list[index] == 119:
        ...
        pass
if Type == 'Young':
    plt.savefig('/Users/sonmjack/Downloads/age2 result_nov/signal_corr/'+'Whole tuning curve'+'.jpg')
    plt.close()
elif Type == 'Old':
    plt.savefig('/Users/sonmjack/Downloads/age10 result_nov/signal_corr/'+'Whole tuning curve'+'.jpg')
    plt.close()
#%%
...
for index in range(len(All_noise_corr)):
    if gene_list[index] == 119:
        ...
        pass
if Type == 'Young':
    plt.savefig('/Users/sonmjack/Downloads/age2 result_nov/noise_corr/'+'Whole noise corr'+'.jpg')
    plt.close()
elif Type == 'Old':
    plt.savefig('/Users/sonmjack/Downloads/age10 result_nov/noise_corr/'+'Whole noise corr'+'.jpg')
    plt.close()
...
#
# if Type == 'Young':
#     with open('/Users/sonmjack/Downloads/age2 result_nov/nov_all_EPSP_young.pkl', 'wb') as file:
#         pickle.dump(All_dy_list, file)
# elif Type == 'Old':
#     with open('/Users/sonmjack/Downloads/age10 result_nov/nov_all_EPSP.pkl', 'wb') as file:
#         pickle.dump(All_dy_list, file)
#%%
# plt.close()
...
for index in range(len(All_dy_list)):
    if gene_list[index] == 119:
        ...
        pass
if Type == 'Young':
    plt.savefig('/Users/sonmjack/Downloads/age2 result_nov/signal_corr/'+'Whole EPSP'+'.jpg')
    plt.close()
if Type == 'Old':
    plt.savefig('/Users/sonmjack/Downloads/age10 result_nov/signal_corr/'+'Whole EPSP'+'.jpg')
    plt.close()
# plt.close()
# plt.figure(figsize=(8, 6))
...
# 图像文件路径
if Type == 'Young':
    image_files = ['/Users/sonmjack/Downloads/age2 result_nov/signal_corr/'+'Whole tuning curve.jpg',
                   '/Users/sonmjack/Downloads/age2 result_nov/signal_corr/'+'Whole signal corr.jpg',
                   '/Users/sonmjack/Downloads/age2 result_nov/signal_corr/'+'Whole EPSP.jpg',
                   '/Users/sonmjack/Downloads/age2 result_nov/noise_corr/'+'Whole noise corr.jpg']
if Type == 'Old':
    image_files = ['/Users/sonmjack/Downloads/age10 result_nov/signal_corr/'+'Whole tuning curve.jpg',
                   '/Users/sonmjack/Downloads/age10 result_nov/signal_corr/'+'Whole signal corr.jpg',
                   '/Users/sonmjack/Downloads/age10 result_nov/signal_corr/'+'Whole EPSP.jpg',
                   '/Users/sonmjack/Downloads/age10 result_nov/noise_corr/'+'Whole noise corr.jpg']
# 打开图像并放入列表
...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/sonmjack/Downloads/age2 result_nov/signal_corr/combined_image_WT.jpg')
if Type == 'Old':
    new_image.save('/Users/sonmjack/Downloads/age10 result_nov/signal_corr/combined_image_WT.jpg')
#%%
...
for index in range(len(All_spike)):
    if gene_list[index] == 116:
        ...
        pass
if Type == 'Young':
    with open('/Users/sonmjack/Downloads/age2 result_nov/nov_signal_corr_AD', 'wb') as file:
        pickle.dump(All_signal_corr_AD, file)
    plt.savefig('/Users/sonmjack/Downloads/age2 result_nov/signal_corr/'+'Whole signal corr'+'.jpg')
elif Type == 'Old':
    with open('/Users/sonmjack/Downloads/age10 result_nov/nov_signal_corr_AD', 'wb') as file:
        pickle.dump(All_signal_corr_AD, file)
    plt.savefig('/Users/sonmjack/Downloads/age10 result_nov/signal_corr/'+'Whole signal corr'+'.jpg')
#%%
if Type == 'Young':
...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/sonmjack/Downloads/age2 result_nov/signal_corr/combined_image_AD.jpg')
if Type == 'Old':
    new_image.save('/Users/sonmjack/Downloads/age10 result_nov/signal_corr/combined_image_AD.jpg')