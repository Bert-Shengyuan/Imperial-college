...
#Type = 'Old'
if Type == 'Young':
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_S_spike.pkl', 'rb') as file:
        All_spike =  pickle.load(file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_laps.pkl', 'rb') as file:
    ...
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_S_index.pkl', 'rb') as file:
    ...
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_S_spike.pkl', 'rb') as file:
        All_spike =  pickle.load(file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_laps.pkl', 'rb') as file:
        All_laps = pickle.load(file)
    ...
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_S_df_f.pkl', 'rb') as file:
        All_df_f = pickle.load(file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_S_index.pkl', 'rb') as file:
        All_spike_index = pickle.load(file)
...
be_x = be_data['nov_x']
be_y = be_data['nov_y']
be_time = be_data['nov_time']
be_speed = be_data['nov_speed']

# weights = All_tuning_curve[0][182,:]  # Replace with your actual weight values
# num_parts = 10
...
ax.set_title("Firing rate map  (Nov)", fontsize=24)
ax.set_xticks([])
ax.set_yticks([])
# Add colorbar
...
plt.tight_layout()
plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/figure_compare/firing rate map/' + str(index) + '_young_nov_'+str(neuron)+'.png',dpi=800)
plt.show()
# Display the plot
# fig, ax = plt.subplots(figsize=(8, 6))
# # Create the heatmap plot
...
# ax.set_title("Count Field (Nov)", fontsize=14)
# # Add colorbar
# cbar = fig.colorbar(countmap, ax=ax)
# cbar.set_label('Spike Strength', fontsize=12)
# # Adjust the plot layout
# plt.tight_layout()
# plt.show()
...
for index in range(len(All_spike)):
    ...
    if Type == 'Young':
        plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/tuning_curve_new/'+f'{type}_{index}'+'.jpg')
    elif Type =='Old':
        plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/tuning_curve_new/' + f'{type}_{index}' + '.jpg')
    plt.close()
...
# if Type == 'Young':
#     with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_angle_noise.pkl', 'wb') as file:
#         pickle.dump(All_angle_noise, file)
#     with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_noise_corr.pkl', 'wb') as file:
#         pickle.dump(All_noise_corr, file)
# elif Type =='Old':
#     with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_angle_noise.pkl', 'wb') as file:
#         pickle.dump(All_angle_noise, file)
#     with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_noise_corr.pkl', 'wb') as file:
#         pickle.dump(All_noise_corr, file)
#%%
if Type == 'Young':
...
for index in range(len(All_spike)):
    if gene_list[index] == 119:
        ...
        pass
if Type == 'Young':
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_signal_corr_WT', 'wb') as file:
        pickle.dump(All_signal_corr_WT, file)
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/signal_corr/' + 'Whole signal corr' + '.jpg')
    plt.close()
elif Type == 'Old':
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_signal_corr_WT', 'wb') as file:
        pickle.dump(All_signal_corr_WT, file)
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/signal_corr/' + 'Whole signal corr' + '.jpg')
    plt.close()


#%%
print('Whole tuning curve wt')
if Type == 'Young':
    gene_list = gene_list_young
    fig, axes = plt.subplots(11, 1, figsize=(8, 66))
elif Type == 'Old':
...
for index in range(len(All_tuning_curve)):
    if gene_list[index] == 119:
        ...
        pass
if Type == 'Young':
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/signal_corr/'+'Whole tuning curve'+'.jpg')
    plt.close()
elif Type == 'Old':
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/signal_corr/'+'Whole tuning curve'+'.jpg')
    plt.close()
#%%
print('Whole noise corr wt')
if Type == 'Young':
    gene_list = gene_list_young
    fig, axes = plt.subplots(11, 1, figsize=(8, 66))
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_noise_corr.pkl', 'rb') as file:
...
for index in range(len(All_noise_corr)):
    if gene_list[index] == 119:
        ...
        pass
if Type == 'Young':
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/noise_corr/'+'Whole noise corr'+'.jpg')
    plt.close()
elif Type == 'Old':
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/noise_corr/'+'Whole noise corr'+'.jpg')
    plt.close()
...
#
# if Type == 'Young':
#     with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_EPSP_young.pkl', 'wb') as file:
#         pickle.dump(All_dy_list, file)
# elif Type == 'Old':
#     with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_EPSP.pkl', 'wb') as file:
#         pickle.dump(All_dy_list, file)
#%%
# plt.close()
...
for index in range(len(All_dy_list)):
    if gene_list[index] == 119:
        ...
        pass
if Type == 'Young':
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/signal_corr/'+'Whole EPSP'+'.jpg')
    plt.close()
if Type == 'Old':
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/signal_corr/'+'Whole EPSP'+'.jpg')
    plt.close()
# plt.close()
# plt.figure(figsize=(8, 6))
...
# 图像文件路径
if Type == 'Young':
    image_files = ['/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/signal_corr/'+'Whole tuning curve.jpg',
                   '/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/signal_corr/'+'Whole signal corr.jpg',
                   '/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/signal_corr/'+'Whole EPSP.jpg',
                   '/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/noise_corr/'+'Whole noise corr.jpg']
if Type == 'Old':
    image_files = ['/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/signal_corr/'+'Whole tuning curve.jpg',
                   '/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/signal_corr/'+'Whole signal corr.jpg',
                   '/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/signal_corr/'+'Whole EPSP.jpg',
                   '/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/noise_corr/'+'Whole noise corr.jpg']
# 打开图像并放入列表
...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/signal_corr/combined_image_WT.jpg')
if Type == 'Old':
    new_image.save('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/signal_corr/combined_image_WT.jpg')
#%%
...
for index in range(len(All_spike)):
    if gene_list[index] == 116:
        ...
        pass
if Type == 'Young':
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_signal_corr_AD', 'wb') as file:
        pickle.dump(All_signal_corr_AD, file)
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/signal_corr/'+'Whole signal corr'+'.jpg')
elif Type == 'Old':
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_signal_corr_AD', 'wb') as file:
        pickle.dump(All_signal_corr_AD, file)
    plt.savefig('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/signal_corr/'+'Whole signal corr'+'.jpg')
#%%
if Type == 'Young':
...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/signal_corr/combined_image_AD.jpg')
if Type == 'Old':
    new_image.save('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/signal_corr/combined_image_AD.jpg')