...
with open('/Users/sonmjack/Downloads/simon_paper/nov_list_age2.pkl', 'rb') as file:
...
with open('/Users/sonmjack/Downloads/simon_paper/nov_neuron_list_age10.pkl', 'rb') as file:
...
with open('/Users/sonmjack/Downloads/simon_paper/nov_df_f_list_age2.pkl', 'rb') as file:
    neuron_time_list_young_nov = pickle.load(file)
with open('/Users/sonmjack/Downloads/simon_paper/nov_df_f_list_age10.pkl', 'rb') as file:
...
#%%
if type == 'Young':
    with open('/Users/sonmjack/Downloads/age2 result_fam1/fam1_S_df_f.pkl', 'wb') as file:
        pickle.dump(All_df_f_Sfam1, file)
    with open('/Users/sonmjack/Downloads/age2 result_fam1/fam1_S_tuning curve.pkl', 'wb') as file:
        pickle.dump(All_tuning_curve_Sfam1, file)
    with open('/Users/sonmjack/Downloads/age2 result_fam1/fam1_S_spike.pkl', 'wb') as file:
        pickle.dump(All_spike_Sfam1, file)
    with open('/Users/sonmjack/Downloads/age2 result_fam1/fam1_S_index.pkl', 'wb') as file:
        pickle.dump(All_spike_index_Sfam1, file)

    with open('/Users/sonmjack/Downloads/age2 result_nov/nov_S_df_f.pkl', 'wb') as file:
        pickle.dump(All_df_f_Snov, file)
    with open('/Users/sonmjack/Downloads/age2 result_nov/nov_S_tuning curve.pkl', 'wb') as file:
        pickle.dump(All_tuning_curve_Snov, file)
    with open('/Users/sonmjack/Downloads/age2 result_nov/nov_S_spike.pkl', 'wb') as file:
        pickle.dump(All_spike_Snov, file)
    with open('/Users/sonmjack/Downloads/age2 result_nov/nov_S_index.pkl', 'wb') as file:
        pickle.dump(All_spike_index_Snov, file)


    with open('/Users/sonmjack/Downloads/age2 result_fam1r2/fam1r2_S_df_f.pkl', 'wb') as file:
        pickle.dump(All_df_f_Sfam1r2, file)
    with open('/Users/sonmjack/Downloads/age2 result_fam1r2/fam1r2_S_tuning curve.pkl', 'wb') as file:
        pickle.dump(All_tuning_curve_Sfam1r2, file)
    with open('/Users/sonmjack/Downloads/age2 result_fam1r2/fam1r2_S_spike.pkl', 'wb') as file:
        pickle.dump(All_spike_Sfam1r2, file)
    with open('/Users/sonmjack/Downloads/age2 result_fam1r2/fam1r2_S_index.pkl', 'wb') as file:
        pickle.dump(All_spike_index_Sfam1r2, file)



    with open('/Users/sonmjack/Downloads/age2 result_fam1/fam1_all_Smask.pkl', 'wb') as file:
        pickle.dump(All_mask, file)



elif type == 'Old':
    with open('/Users/sonmjack/Downloads/age10 result_fam1/fam1_S_df_f.pkl', 'wb') as file:
        pickle.dump(All_df_f_Sfam1, file)
    with open('/Users/sonmjack/Downloads/age10 result_fam1/fam1_S_tuning curve.pkl', 'wb') as file:
        pickle.dump(All_tuning_curve_Sfam1, file)
    with open('/Users/sonmjack/Downloads/age10 result_fam1/fam1_S_spike.pkl', 'wb') as file:
        pickle.dump(All_spike_Sfam1, file)
    with open('/Users/sonmjack/Downloads/age10 result_fam1/fam1_S_index.pkl', 'wb') as file:
        pickle.dump(All_spike_index_Sfam1, file)

    with open('/Users/sonmjack/Downloads/age10 result_nov/nov_S_df_f.pkl', 'wb') as file:
        pickle.dump(All_df_f_Snov, file)
    with open('/Users/sonmjack/Downloads/age10 result_nov/nov_S_tuning curve.pkl', 'wb') as file:
        pickle.dump(All_tuning_curve_Snov, file)
    with open('/Users/sonmjack/Downloads/age10 result_nov/nov_S_spike.pkl', 'wb') as file:
        pickle.dump(All_spike_Snov, file)
    with open('/Users/sonmjack/Downloads/age10 result_nov/nov_S_index.pkl', 'wb') as file:
        pickle.dump(All_spike_index_Snov, file)


    with open('/Users/sonmjack/Downloads/age10 result_fam1r2/fam1r2_S_df_f.pkl', 'wb') as file:
        pickle.dump(All_df_f_Sfam1r2, file)
    with open('/Users/sonmjack/Downloads/age10 result_fam1r2/fam1r2_S_tuning curve.pkl', 'wb') as file:
        pickle.dump(All_tuning_curve_Sfam1r2, file)
    with open('/Users/sonmjack/Downloads/age10 result_fam1r2/fam1r2_S_spike.pkl', 'wb') as file:
        pickle.dump(All_spike_Sfam1r2, file)
    with open('/Users/sonmjack/Downloads/age10 result_fam1r2/fam1r2_S_index.pkl', 'wb') as file:
        pickle.dump(All_spike_index_Sfam1r2, file)


    with open('/Users/sonmjack/Downloads/age10 result_fam1/fam1_all_Smask.pkl', 'wb') as file:
        pickle.dump(All_mask, file)