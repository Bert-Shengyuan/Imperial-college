...
path = '/Users/sonmjack/Downloads/simon_paper/shengyuan_trigger_nov.npy'
np.save(path,mat_trigger)
#%%
mat_trigger = np.load('/Users/sonmjack/Downloads/simon_paper/shengyuan_trigger_nov.npy')
#%%  age ==2  nov
#neuron_spike = []
be_list = []
gene_list = []
...
import pickle
with open('/Users/sonmjack/Downloads/simon_paper/nov_df_f_list_age2.pkl', 'wb') as file:
    pickle.dump(neuron_time_list, file)
#%% save data
import pickle
with open('/Users/sonmjack/Downloads/simon_paper/nov_list_age2.pkl', 'wb') as file:
    pickle.dump(neuron_spike, file)

with open('/Users/sonmjack/Downloads/simon_paper/nov_ex_index_age2.pkl', 'wb') as file:
    pickle.dump(ex_index, file)

with open('/Users/sonmjack/Downloads/simon_paper/nov_mutual_list_age2.pkl', 'wb') as file:
...
with open('/Users/sonmjack/Downloads/simon_paper/nov_ex_index_age2.pkl', 'rb') as file:
    ex_index = pickle.load(file)

with open('/Users/sonmjack/Downloads/simon_paper/nov_mutual_list_age2.pkl', 'rb') as file:
...
for k in range(len(neuron_index)):#len(neuron_index)
    ...
    dy_list.append(dy_d)
#%%
with open('/Users/sonmjack/Downloads/simon_paper/dynamic_version2_list_Nov_age2.pkl', 'wb') as file:
    pickle.dump(dy_list, file)
#%%
with open('/Users/sonmjack/Downloads/simon_paper/dynamic_version2_list_Nov_age2.pkl', 'rb') as file:
...
for k in range(len(neuron_spike)):
    ...
    plt.xlabel("Neurons")
    plt.savefig('/Users/sonmjack/Downloads/age2 result_nov/' + 'dynamic' + f'-{type}-' + f'{k}.jpg')
    # 可视化降维结果
    ...
    fig.colorbar(p)
    plt.savefig('/Users/sonmjack/Downloads/age2 result_nov/'+'dynamic distence'+f'-{type}-'+f'{k}.jpg')
...
#%%
with open('/Users/sonmjack/Downloads/simon_paper/dynamic_list_Nov_age2_shuffled.pkl', 'rb') as file:
    dy_list_shuffled = pickle.load(file)
#%%
with open('/Users/sonmjack/Downloads/simon_paper/dynamic_list_Nov_age2_shuffled.pkl', 'wb') as file:
...
for i in range(len(dy_list_shuffled)):
    ...
    plt.savefig('/Users/sonmjack/Downloads/age2 result_nov/graph/' + 'weight' + f'-{type}-' + f'{i}.jpg')
    plt.close()
#%%
