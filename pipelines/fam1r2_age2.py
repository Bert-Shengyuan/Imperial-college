...
import pickle
with open('/Users/sonmjack/Downloads/simon_paper/fam1r2_df_f_list_age2.pkl', 'wb') as file:
    pickle.dump(neuron_time_list, file)
#%% save data
import pickle
with open('/Users/sonmjack/Downloads/simon_paper/fam1r2_neuron_list_age2.pkl', 'wb') as file:
    pickle.dump(neuron_spike, file)

with open('/Users/sonmjack/Downloads/simon_paper/fam1r2_ex_index_age2.pkl', 'wb') as file:
    pickle.dump(ex_index, file)

with open('/Users/sonmjack/Downloads/simon_paper/fam1r2_mutual_list_age2.pkl', 'wb') as file:
    pickle.dump(mutual_list, file)

with open('/Users/sonmjack/Downloads/simon_paper/gene_list_age2.pkl', 'wb') as file:
...
with open('/Users/sonmjack/Downloads/simon_paper/fam1r2_ex_index_age2.pkl', 'rb') as file:
    ex_index = pickle.load(file)

with open('/Users/sonmjack/Downloads/simon_paper/fam1r2_mutual_list_age2.pkl', 'rb') as file:
...
with open('/Users/sonmjack/Downloads/simon_paper/dynamic_list_famr2_age2.pkl', 'wb') as file:
    pickle.dump(dy_list, file)

#%%

with open('/Users/sonmjack/Downloads/simon_paper/dynamic_list_famr2_age2.pkl', 'rb') as file:
...
for k in range(len(neuron_spike)):
    ...
    plt.xlabel("Neurons")
    plt.savefig('/Users/sonmjack/Downloads/age2 result_fam1r2/' + 'dynamic' + f'-{type}-' + f'{k}.jpg')
    # 可视化降维结果
    ...
    fig.colorbar(p)
    plt.savefig('/Users/sonmjack/Downloads/age2 result_fam1r2/'+'dynamic distence'+f'-{type}-'+f'{k}.jpg')
...
#%%
with open('/Users/sonmjack/Downloads/simon_paper/dynamic_list_famr2_age2_shuffled.pkl', 'rb') as file:
    dy_list_shuffled = pickle.load(file)
#%%
with open('/Users/sonmjack/Downloads/simon_paper/dynamic_list_famr2_age2_shuffled.pkl', 'wb') as file:
