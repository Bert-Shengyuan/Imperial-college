...
#%%
if type == 'Young':
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_spike.pkl', 'wb') as file:
        pickle.dump(All_spike, file)

    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_laps.pkl', 'wb') as file:
        pickle.dump(All_laps, file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_mask.pkl', 'wb') as file:
        pickle.dump(All_mask, file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_df_f.pkl', 'wb') as file:
        pickle.dump(All_df_f, file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_spike_index.pkl', 'wb') as file:
        pickle.dump(All_spike_index, file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age2 result_nov/nov_all_tuning curve.pkl', 'wb') as file:
        pickle.dump(All_tuning_curve, file)
elif type == 'Old':
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_spike.pkl', 'wb') as file:
        pickle.dump(All_spike, file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_laps.pkl', 'wb') as file:
        pickle.dump(All_laps, file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_mask.pkl', 'wb') as file:
        pickle.dump(All_mask, file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_df_f.pkl', 'wb') as file:
        pickle.dump(All_df_f, file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_spike_index.pkl', 'wb') as file:
        pickle.dump(All_spike_index, file)
    with open('/Users/shengyuancai/Downloads/Imperial paper/Data/age10 result_nov/nov_all_tuning curve.pkl', 'wb') as file:
        pickle.dump(All_tuning_curve, file)
