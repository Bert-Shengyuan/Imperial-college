...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/sonmjack/Downloads/age2 result_fam1r2/signal_corr/corr WT df_13.jpg')
if Type == 'Old':
    new_image.save('/Users/sonmjack/Downloads/age10 result_fam1r2/signal_corr/corr WT df_13.jpg')
#%%
#%%
from PIL import Image
import os
...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/sonmjack/Downloads/age2 result_fam1r2/signal_corr/corr WT df_12.jpg')
if Type == 'Old':
    new_image.save('/Users/sonmjack/Downloads/age10 result_fam1r2/signal_corr/corr WT df_12.jpg')
#%%
from PIL import Image
import os
# 图像文件路径
...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/sonmjack/Downloads/age2 result_fam1r2/signal_corr/corr WT df_23.jpg')
if Type == 'Old':
    new_image.save('/Users/sonmjack/Downloads/age10 result_fam1r2/signal_corr/corr WT df_23.jpg')
...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/sonmjack/Downloads/age2 result_fam1r2/signal_corr/corr WT tuning_13.jpg')
if Type == 'Old':
    new_image.save('/Users/sonmjack/Downloads/age10 result_fam1r2/signal_corr/corr WT tuning_13.jpg')
...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/sonmjack/Downloads/age2 result_fam1r2/signal_corr/corr WT tuning_12.jpg')
if Type == 'Old':
    new_image.save('/Users/sonmjack/Downloads/age10 result_fam1r2/signal_corr/corr WT tuning_12.jpg')
#%%
from PIL import Image
import os
# 图像文件路径
...
# 保存新图像
if Type == 'Young':
    new_image.save('/Users/sonmjack/Downloads/age2 result_fam1r2/signal_corr/corr WT tuning_23.jpg')
if Type == 'Old':
    new_image.save('/Users/sonmjack/Downloads/age10 result_fam1r2/signal_corr/corr WT tuning_23.jpg')